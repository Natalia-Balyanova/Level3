...
public class DbAuthenticationProvider implements AuthenticationProvider {
    ...
    private static void fillChatClientsTable() throws SQLException {//заполнили таблицу в БД
        connection.setAutoCommit(false);
        stmt.executeUpdate("insert into chatclients (login, password, nickname) values ('Max', '123', 'Max');");
        stmt.executeUpdate("insert into chatclients (login, password, nickname) values ('Nata', '123', 'Nata');");
        stmt.executeUpdate("insert into chatclients (login, password, nickname) values ('Kate', '123', 'Kate');");
        stmt.executeUpdate("insert into chatclients (login, password, nickname) values ('Alex', '123', 'Alex');");
        stmt.executeUpdate("insert into chatclients (login, password, nickname) values ('Julia', '123', 'Julia');");
